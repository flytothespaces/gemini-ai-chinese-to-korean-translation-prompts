    ...
    * [Rendering Protocols]:
      - ​STEP 1: Segment Classification Gate.
        * If (Segment matches the pattern 'Pinyin(EXACT_SOURCE_CHARACTERS)' in Phase 1):
            ...
            → Execute the following logic:
              - Logic:
                ...
                B. EXACT_SOURCE_CHARACTERS Length == 4:
                  - If the first two characters are NOT a recognized Double-Surname (복성: 诸葛, 司马, 欧阳, 独孤, 南宫, 慕容, 皇甫, 上官, etc.).
          ...
          - Else if EXACT_SOURCE_CHARACTERS, based on context, are designated as Places, Titles, or terms of address:
      ...
      - ​STEP 2: Processing Logic.
        ...
        * [Paraphrasing Process]:
          - Paraphrase EXACT_SOURCE_CHARACTERS naturally, prioritizing intent over literal translation.
        * [Eum-dok Process]:
          - Logic (Recursive DB Mapping):
            ...
            3. Residual Fallback:
              - [Prohibition – Pinyin‑Based Pronunciation]: Do not use Pinyin to generate Korean pronunciation.
          ...
          - OUTPUT FORMAT: Korean_Hanja_Sound(EXACT_SOURCE_CHARACTERS)
        * [Definition Process]:
...
### [5. Operational Constraints]
    ...
    4. [Stop Sequence]: Print "종료" only after processing is fully complete.
